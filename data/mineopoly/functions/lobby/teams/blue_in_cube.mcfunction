...
tellraw @a ["",{"text":"Blue","bold":true,"color":"blue"},{"text":" is occupied!","color":"green"}]
...
data merge block -5 69 -476 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"execute as @p run function mineopoly:lobby/teams/blue_in_cube_reset"}}',Text2:'["",{"text":"[","bold":true,"color":"dark_gray"},{"text":"Ready","bold":true,"color":"green"},{"text":"]","bold":true,"color":"dark_gray"}]'}
