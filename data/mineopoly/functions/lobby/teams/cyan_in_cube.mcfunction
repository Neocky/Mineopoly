...
tellraw @a ["",{"text":"Cyan ","bold":true,"color":"aqua"},{"translate":"mineopoly.teams.occupied","color":"green"}]
...
tag @s add team_cyan
execute positioned -4 64 -479 as @a[distance=..2.8, tag=!team_cyan] run tp @s -1 64 -489
