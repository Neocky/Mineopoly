...
execute if score @s money < #buyHousePrice priceHandler unless score #tempPropertyScore fieldProperty matches 7.. unless score #tempPropertyScore fieldProperty matches ..1 run tellraw @s {"text":"Not enough money. Please translate me!"}
