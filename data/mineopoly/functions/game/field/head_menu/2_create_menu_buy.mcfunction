...
# brown_1 armor stand
execute if score @s currentField matches 1 positioned -25 63.75 2 run summon armor_stand ~ ~ ~1 {Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b,Rotation:[270f],CustomName:'[{"translate":"mineopoly.game.menu.buy_property", "bold": true, "color": "red"},{"text":" [-","color":"red"},{"score":{"name":"#buyPrice","objective":"priceHandler"},"color":"red"},{"text":"]","color":"red"}]',CustomNameVisible:1b,Tags:["menu_buy","head_menu"],DisabledSlots:4144959}
