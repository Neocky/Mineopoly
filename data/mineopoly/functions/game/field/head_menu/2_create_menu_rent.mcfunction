...
summon minecraft:creeper 7 64 -7 {NoGravity:1b, NoAI:1b, PersistenceRequired:1b,Silent:1b,DeathLootTable:"minecraft:empty", Tags:["menu_rent_go_back","head_menu"], ActiveEffects:[{Id:14,Amplifier:0,Duration:20000000,ShowParticles:0b}]}

# brown_1 armor stand
execute if score @s currentField matches 1 positioned -25 63.75 2 run summon armor_stand ~ ~ ~1 {Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b,Rotation:[270f],CustomName:'{"translate":"mineopoly.game.menu.pay_rent", "bold": true, "color": "red"}',CustomNameVisible:1b,Tags:["menu_pay_rent","head_menu"],DisabledSlots:4144959}
execute if score @s currentField matches 1 positioned -25 63.75 2 run summon armor_stand ~ ~ ~-1 {Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b,Rotation:[270f],CustomName:'{"translate":"mineopoly.game.menu.go_back", "bold": true, "color": "gray"}',CustomNameVisible:1b,Tags:["menu_rent_go_back","head_menu"],DisabledSlots:4144959}
