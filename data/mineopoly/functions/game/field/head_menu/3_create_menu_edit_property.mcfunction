...
execute if score @s currentField matches 1 positioned -25 63.75 2 if entity @s[tag=property_brown_1, tag=property_brown_2] run tp @e[type=minecraft:creeper, tag=menu_edit_property_buy] ~ ~1 ~1.5
execute if score @s currentField matches 1 positioned -25 63.75 2 if entity @s[tag=property_brown_1, tag=property_brown_2] run tp @e[type=minecraft:creeper, tag=mmenu_edit_property_sell] ~ ~1 ~0.5
execute if score @s currentField matches 1 positioned -25 63.75 2 run tp @e[type=minecraft:creeper, tag=menu_edit_property_mortgage] ~ ~1 ~-0.5
execute if score @s currentField matches 1 positioned -25 63.75 2 run tp @e[type=minecraft:creeper, tag=menu_edit_property_back] ~ ~1 ~-1.5
