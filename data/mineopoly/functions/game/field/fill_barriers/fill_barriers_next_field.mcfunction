...
execute positioned -19 50 148 if entity @e[type= minecraft:player, x=-50 , y=50, z=-38, dx=-32, dy=100, dz=31, scores={field=11..}, limit=1] run fill ~-9 ~ ~3 ~-9 ~36 ~-3 minecraft:air
