...
execute positioned -19 50 148 if entity @e[type= minecraft:player, x=-50 , y=50, z=-38, dx=-32, dy=100, dz=31, scores={field=10..}, limit=1] run fill -51 64 179 -51 100 173 minecraft:air
